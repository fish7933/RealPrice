# Project Summary
This project is an advanced freight cost calculator designed for logistics companies, enhancing operational efficiency by delivering accurate shipping cost estimates. It assesses various factors, including ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent improvements have focused on data loading processes, user experience, and robust error handling, particularly in the context of historical data management.

# Project Module Description
The project comprises several functional modules:
- **CostCalculatorWithTabs**: Main component for calculating freight costs with a tabbed interface.
...
- **FreightContext**: Manages freight data operations.
- **SeaFreightHistory**: Manages historical freight records.
- **FreightSqlDialog**: Displays SQL queries related to freight calculations.
...
- **FreightSqlDialog.tsx**: Displays SQL queries related to freight calculations.
