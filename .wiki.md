# Project Summary
Shadcn-UI is a logistics and shipping web application designed to optimize freight management for businesses. It offers a comprehensive suite of features such as a Cost Calculator for evaluating shipping options, analyzing historical freight data, and managing user roles and permissions. Utilizing Supabase for backend data management, the platform enhances efficiency in cost evaluations, route planning, auditing, and user management. Recent updates have focused on improving user authentication interfaces and enhancing the Cost Calculator's functionality.
