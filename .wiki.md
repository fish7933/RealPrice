# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, optimizing shipping cost estimations by considering various factors like ports of loading (POL), ports of discharge (POD), weight, and additional fees. The application enhances operational efficiency and aids in decision-making by allowing users to compute and compare freight costs across diverse shipping methods. Recent updates have notably improved the user experience, particularly in the CostResultTable component, featuring enhanced visual indicators and comprehensive cost breakdowns.
