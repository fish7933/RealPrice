# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, enhancing operational efficiency by providing accurate shipping cost estimates. It considers various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. The latest updates include improved SQL query generation capabilities in the calculator's dialog components, facilitating better data management and user experience.
...
│   │   └── CalculationSqlPreviewDialog.tsx
│   ├── agents/
│   │   ├── RailAgentTable.tsx
│   │   ├── TruckAgentTable.tsx
...
- **CalculationSqlPreviewDialog.tsx**: Previews generated SQL queries.
...
- **freightLoaders.ts**: Handles loading of freight-related data.
- **auditLogExport.ts**: Utility for exporting audit logs.
- **supabase.ts**: Configures Supabase client.
- **testHistoricalFreight.ts**: Contains tests for historical freight data.
