# Project Summary
Shadcn-UI is a logistics and shipping web application designed to optimize freight management for businesses. It provides features such as a Cost Calculator, historical freight data analysis, and user role management. By leveraging Supabase for backend operations, the platform aims to improve efficiency in cost evaluations, route planning, and user authentication. Recent updates have focused on enhancing user authentication and improving the Cost Calculator's functionality.
