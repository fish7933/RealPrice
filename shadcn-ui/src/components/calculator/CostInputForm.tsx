...
export default function CostInputForm({
  ...
  return (
    <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm">
      <CardHeader className="bg-gradient-to-r from-blue-50 via-cyan-50 to-indigo-50 border-b-2 border-gradient-to-r from-blue-200 to-cyan-200">
        ...
        <CardDescription className="text-base text-gray-600 font-medium ml-14">운송 경로를 입력하세요</CardDescription>
      </CardHeader>
