# Project Summary
This project is an advanced freight cost calculator designed specifically for logistics companies. It aims to enhance operational efficiency by providing precise shipping cost estimations that take into account various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. The latest updates have introduced a robust historical freight data management system, complete with version control, batch deletion, detailed audit logging, and Excel export capabilities. This project also integrates a new context for managing freight data operations and state, thereby improving user experience and data handling.
