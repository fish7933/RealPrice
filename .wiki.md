# Project Summary
This project is an advanced freight cost calculator designed for logistics companies, enhancing operational efficiency by optimizing shipping cost estimations. It considers various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. The application allows users to compute and compare freight costs across multiple shipping methods, aiding decision-making. Recent improvements include enhanced input handling in the BorderDestinationTable component and the introduction of batch operations with audit logging capabilities.
...
- **BorderDestinationTable**: Manages freight rates for border destinations with batch operation capabilities and enhanced input handling.
...
- **BorderDestinationTable.tsx**: Manages freight rates for border destinations with improved input handling and batch operations.
