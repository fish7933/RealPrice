# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, aimed at improving operational efficiency by optimizing shipping cost estimations. It evaluates various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Users can compute and compare freight costs across multiple shipping methods, facilitating better decision-making. Recent enhancements include improved input handling in the BorderDestinationTable component and the addition of versioning for freight rates with audit logging capabilities.
