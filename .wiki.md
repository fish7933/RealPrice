# Project Summary
This project is an advanced freight cost calculator designed for logistics companies. It enhances operational efficiency by delivering accurate shipping cost estimates that factor in various elements such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent updates have improved SQL query generation capabilities, leading to better data management and user experience.
