# Project Summary
Shadcn-UI is a logistics and shipping web application designed to optimize freight management for businesses. It offers features such as cost calculation, historical data analysis, and user role management, leveraging Supabase for backend services. Recent updates focus on enhancing user authentication, refining the Cost Calculator, improving audit log management, and optimizing deployment settings.
