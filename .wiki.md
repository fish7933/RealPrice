# Project Summary
This project is an advanced freight cost calculator designed for logistics companies, enhancing operational efficiency through precise shipping cost estimations. It incorporates various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent improvements include robust validation for POL selection, preventing null values from being sent to the database, and enhanced user feedback for data entry errors. The latest updates focus on improving the management of freight data, including batch deletion, version control for freight rates, and refined dialogs for handling freight updates.
...
- **PortBorderTable**: Manages freight rates for border crossings, including improved POL validation and enhanced handling of freight rates.
