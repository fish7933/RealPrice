# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, enhancing operational efficiency through precise shipping cost estimations. It incorporates factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent updates have improved user feedback mechanisms, robust validation for POL selection, and advanced management features for freight data, including batch deletion and version control for freight rates. Moreover, audit logging for freight operations has been enhanced, ensuring better tracking and accountability.
...
- **AuditLogTable**: Manages and displays audit logs of freight-related changes, including improved handling of POL validations.
...
- **AuditLogTable.tsx**: Displays version history logs and manages audit logs with improved handling of POL.
