# Project Summary
This project is an advanced freight cost calculator designed for logistics companies, aimed at enhancing operational efficiency through precise shipping cost estimations. It factors in various elements such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent enhancements include improved validation for POL selection, ensuring that no null values are passed to the database, and better user feedback for errors during data entry.
...
- **PortBorderTable**: Manages freight rates for border crossings, now includes improved POL validation.
