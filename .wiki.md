# Project Summary
This project is an advanced freight cost calculator specifically designed for logistics companies. It optimizes shipping cost estimations by considering various factors like ports of loading (POL), ports of discharge (POD), weight, and additional fees. The application enhances operational efficiency and supports decision-making by enabling users to compute and compare freight costs across multiple shipping methods. Recent updates include improvements in the user experience, particularly within the BorderDestinationTable component, which now features enhanced input handling for freight rates.
...
- **BorderDestinationTable.tsx**: Manages freight rates for border destinations with improved input handling.
