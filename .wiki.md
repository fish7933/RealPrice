# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, designed to optimize shipping cost estimations based on various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. It enhances operational efficiency and decision-making by allowing users to compute and compare freight costs across different shipping methods. Recent updates have improved the user experience, particularly in the CostResultTable component, which now highlights the most economical options with enhanced visual indicators and additional features for cost breakdown.
...
- **CostResultTable**: Displays optimized cost calculation results, highlighting agent codes and the lowest prices, with improved cost breakdown features.
