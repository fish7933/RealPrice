# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, aimed at enhancing operational efficiency by providing accurate shipping cost estimations. It takes into account various factors including ports of loading (POL), ports of discharge (POD), weight, and additional fees, enabling users to make informed shipping decisions. Recent enhancements include the integration of port border freights and improved audit logging capabilities.
