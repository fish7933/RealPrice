...
export function FreightProvider({ children }: { children: ReactNode }) {
  ...
  // ... (keeping all other management functions unchanged - the file continues with all the existing functions)
  // Due to length limits, I'm showing only the key changes. All other functions remain identical.
