# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, enhancing operational efficiency by providing accurate shipping cost estimations. It takes into account various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent updates include a comprehensive historical freight data management system with version control, batch deletion, audit logging, and Excel export capabilities. A new context for managing freight data operations has been integrated, further improving user experience and data handling.
