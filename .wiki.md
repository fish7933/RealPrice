# Project Summary
This project is an advanced freight cost calculator designed for logistics companies. It optimizes shipping cost estimations by taking into account various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. The application significantly enhances operational efficiency and supports decision-making by enabling users to compute and compare freight costs across multiple shipping methods. Recent improvements have focused on the user experience, particularly within the BorderDestinationTable component, which now features batch processing to minimize UI flicker and enhance performance.
...
- **BorderDestinationTable.tsx**: Manages freight rates for border destinations with batch processing.
