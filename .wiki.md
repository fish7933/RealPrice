# Project Summary
Shadcn-UI is a logistics and shipping web application that streamlines freight management for businesses. It offers an array of features such as a Cost Calculator for assessing shipping options, analyzing historical freight data, and managing user roles and permissions. Utilizing Supabase for backend data management, the platform enhances operational efficiency in cost evaluations, route planning, auditing, and user management. Recent updates have prioritized user authentication improvements and enhanced functionalities for the Cost Calculator.
