# Project Summary
This project is an advanced freight cost calculator designed specifically for logistics companies. It improves operational efficiency by delivering precise shipping cost estimates based on various factors, including ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent enhancements feature a robust historical freight data management system with version control, audit logging, and Excel export capabilities. A new context for freight data operations has been integrated, significantly enhancing user experience and data management.
...
- **CalculationSqlPreviewDialog**: New dialog for previewing generated SQL queries based on user input.
...
- **CostInputForm.tsx**: Updated form for inputting cost-related data, now includes SQL preview functionality.
...
- **CalculationSqlPreviewDialog.tsx**: New dialog for previewing generated SQL queries based on user input.
- **FreightSqlDialog.tsx**: New dialog for generating and displaying SQL queries related to freight calculations.
