# Project Summary
This project is an advanced freight cost calculator designed specifically for logistics companies to enhance operational efficiency by providing accurate shipping cost estimations. It takes into account various factors, such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Users can compute and compare freight costs across multiple shipping methods, aiding in better decision-making. Recent updates include improved input handling in the BorderDestinationTable component, the addition of versioning for freight rates with audit logging capabilities, and enhancements to the AuditLogTable for better log management.
...
- **BorderDestinationTable**: Manages freight rates for border destinations, now with batch operation capabilities and enhanced input handling, including versioning for freight rates.
...
- **AuditLogTable**: Manages and displays audit logs of freight-related changes with grouping capabilities.
