# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, aimed at enhancing operational efficiency through precise shipping cost estimations. It incorporates various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent updates have introduced a historical freight data management system, complete with version control, batch deletion, detailed audit logging, and Excel export capabilities. The project also features a new context for managing freight data operations and state, improving user experience and data handling.

# Project Module Description
The project consists of several functional modules:
- **CostCalculatorWithTabs**: Core component for freight cost calculation with a tabbed interface, now supporting historical dates for freight options.
