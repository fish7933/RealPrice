# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies. It optimizes shipping cost estimations by factoring in various elements such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. The application enhances operational efficiency and aids decision-making by allowing users to compute and compare freight costs across multiple shipping methods. Recent updates have focused on improving user experience, especially within the BorderDestinationTable component, which now includes better input handling for freight rates.
