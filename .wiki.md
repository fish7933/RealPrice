# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies. It significantly enhances operational efficiency by providing precise shipping cost estimations while considering various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent updates have introduced a historical freight data management system that supports features such as version control, batch deletion, and detailed audit logging, including Excel export capabilities. The system also includes a new context for managing freight data operations and state.

# Project Module Description
The project consists of several functional modules:
- **CostCalculatorWithTabs**: Main component for freight cost calculation with a tabbed interface.
...
- **TimeMachineDialog**: Dialog for selecting historical dates for freight rate changes, now allowing selection of any past date.
...
- **TimeMachineDialog.tsx**: Enhanced dialog for selecting any historical date, not just those with freight changes.
