# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, enhancing operational efficiency by delivering precise shipping cost estimates based on parameters like ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent updates have improved SQL query handling for historical data, user experience, and error management, alongside new features for filtering historical dates.

# Project Module Description
The project comprises various functional modules:
- **CostCalculatorWithTabs**: Central component for calculating freight costs with a tabbed interface, now supporting historical date input.
...
- **SeaFreightDialog**: Dialog for selecting sea freight options with historical date support.
