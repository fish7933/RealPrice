# Project Summary
This project is an advanced freight cost calculator designed for logistics companies. It enhances operational efficiency by providing accurate shipping cost estimations based on various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent updates have included the integration of port border freights, improved audit logging capabilities, and the addition of a `pol` column to the database schema to support better data management.
