# Project Summary
This project is an advanced freight cost calculator designed for logistics companies, enhancing operational efficiency through precise shipping cost estimations. It incorporates various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent improvements include robust validation for POL selection, preventing null values from being sent to the database, and enhanced user feedback for data entry errors.
