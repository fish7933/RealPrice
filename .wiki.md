# Project Summary
Shadcn-UI is a logistics and shipping web application designed to enhance freight management for businesses. It provides tools for cost estimation, historical data analysis, and user role management, utilizing Supabase for backend services. Recent improvements have focused on refining user authentication, enhancing the Cost Calculator, and optimizing deployment settings for Single Page Application (SPA) routing, all aimed at delivering a more efficient user experience.
...
- **CostCalculatorWithTabs**: Enhanced cost calculation interface with local charge input and updated layout, now includes auto-exclusion of combined freight when DP is selected.
...
- **AuditLogTable**: Display of audit logs, updated to show 5 items per page.
...
- **src/components/calculator/CostCalculatorWithTabs.tsx**: Updated component for cost calculation with tabs, now includes local charge input and auto-exclusion of combined freight when DP is included.
