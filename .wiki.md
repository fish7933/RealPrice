# Project Summary
Shadcn-UI is a logistics and shipping web application designed to enhance freight management for businesses. It provides tools for cost estimation, historical data analysis, and user role management, utilizing Supabase for backend services. Recent updates include improved user authentication, an optimized Cost Calculator, and refined deployment settings for better Single Page Application (SPA) routing, all aimed at enhancing user experience.
...
- **CostCalculator**: Tool for calculating shipping costs with enhanced functionality, now includes DP-based filtering.
