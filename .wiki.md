# Project Summary
This project is an advanced freight cost calculator designed specifically for logistics companies. It enhances operational efficiency by providing accurate shipping cost estimations that consider various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. This allows users to make informed decisions regarding shipping methods. Recent updates include the integration of port border freights and improvements in audit logging capabilities, as well as enhanced user interfaces for better usability.
