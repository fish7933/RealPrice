# Project Summary
This project is an advanced freight cost calculator designed specifically for logistics companies, aiming to improve operational efficiency through precise shipping cost estimations. By factoring in various elements such as ports of loading (POL), ports of discharge (POD), weight, and additional fees, users can compute and compare freight costs across multiple shipping methods. This empowers them to make informed decisions. Recent enhancements have also been made to support better handling of port border freights and to improve audit logging capabilities.
