# Project Summary
Shadcn-UI is a logistics and shipping web application that enhances freight management for businesses. It offers tools for cost estimation, historical data analysis, and user role management, thereby improving the efficiency of freight operations. Key features include user authentication via Supabase, an advanced Cost Calculator, and a dynamic freight options viewer, all designed to enhance user experience and facilitate decision-making.
