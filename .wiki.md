# Project Summary
This project is an advanced freight cost calculator designed for logistics companies, aiming to enhance operational efficiency by providing accurate shipping cost estimations. It factors in various elements, including ports of loading (POL), ports of discharge (POD), weight, and additional fees. The latest updates have added a historical freight data management system, which features version control, batch deletion, detailed audit logging, and Excel export capabilities. The project also includes a new context for managing freight data operations and state.
