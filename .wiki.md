# Project Summary
This project is an advanced freight cost calculator specifically designed for logistics companies. It enhances operational efficiency through precise shipping cost estimations, taking into account various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. Recent updates have improved user feedback mechanisms, robust validation for POL selection, and advanced management features for freight data, including batch deletion, version control for freight rates, and enhanced audit logging with Excel export and version comparison capabilities.
