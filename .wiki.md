# Project Summary
This project is an advanced freight cost calculator designed specifically for logistics companies. It enables users to optimize shipping cost estimations by considering various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees. The application enhances operational efficiency and decision-making by allowing users to compute and compare freight costs across different shipping methods. Recent updates have focused on improving the user experience, particularly in the CostResultTable component, which now highlights the most economical options with enhanced visual indicators.
...
- **CostResultTable**: Displays optimized cost calculation results, highlighting agent codes and the lowest prices.
