          ...
          <CardContent className="pt-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-12 gap-3 mb-6 bg-transparent p-0 h-auto">
                <TabsTrigger 
                  value="agents" 
                  className="flex flex-col items-center justify-center gap-2 h-24 p-4 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all data-[state=active]:bg-gray-100 data-[state=active]:text-gray-900 data-[state=active]:border-gray-700 data-[state=active]:shadow-lg data-[state=active]:scale-105"
                >
                ...
                <TabsTrigger 
                  ...
                  className="flex flex-col items-center justify-center gap-2 h-24 p-4 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all data-[state=active]:bg-gray-100 data-[state=active]:text-gray-900 data-[state=active]:border-gray-700 data-[state=active]:shadow-lg data-[state=active]:scale-105"
                >
                  <Anchor className="h-6 w-6 flex-shrink-0" />
                ...
                <TabsTrigger 
                  ...
                  className="flex flex-col items-center justify-center gap-2 h-24 p-4 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all data-[state=active]:bg-gray-100 data-[state=active]:text-gray-900 data-[state=active]:border-gray-700 data-[state=active]:shadow-lg data-[state=active]:scale-105"
                >
                  <Ship className="h-6 w-6 flex-shrink-0" />
                ...
                <TabsTrigger 
                  ...
                  className="flex flex-col items-center justify-center gap-2 h-24 p-4 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all data-[state=active]:bg-gray-100 data-[state=active]:text-gray-900 data-[state=active]:border-gray-700 data-[state=active]:shadow-lg data-[state=active]:scale-105"
                >
                  <Merge className="h-6 w-6 flex-shrink-0" />
                ...
                <TabsTrigger 
                  ...
                  className="flex flex-col items-center justify-center gap-2 h-24 p-4 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all data-[state=active]:bg-gray-100 data-[state=active]:text-gray-900 data-[state=active]:border-gray-700 data-[state=active]:shadow-lg data-[state=active]:scale-105"
                >
                  <Train className="h-6 w-6 flex-shrink-0" />
                ...
                <TabsTrigger 
                  ...
                  className="flex flex-col items-center justify-center gap-2 h-24 p-4 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all data-[state=active]:bg-gray-100 data-[state=active]:text-gray-900 data-[state=active]:border-gray-700 data-[state=active]:shadow-lg data-[state=active]:scale-105"
                >
                  <Weight className="h-6 w-6 flex-shrink-0" />
