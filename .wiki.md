# Project Summary
This project is an advanced freight cost calculator tailored for logistics companies, focused on enhancing operational efficiency through accurate shipping cost estimations. It integrates various factors such as ports of loading (POL), ports of discharge (POD), weight, and additional fees to compute and compare freight costs across diverse shipping methods. This empowers users to make informed decisions. Recent updates include support for port border freights and improved audit logging capabilities.
